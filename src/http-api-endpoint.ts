...
export type HttpEndpointRequestAgnosticDto = HttpEndpointRequestDto<any>
...
type HttpApiEndpointBuildMiddleware =
    | {
          type: 'sync'
          func: (requestDto: HttpEndpointRequestAgnosticDto) => HttpEndpointRequestAgnosticDto
      }
    | {
          type: 'async'
          func: (
              requestDto: HttpEndpointRequestAgnosticDto
          ) => Promise<HttpEndpointRequestAgnosticDto>
      }
...
export const makeEndpoint = {
    ...
    withBuildSchema: <
        BuildSchema extends z.Schema<HttpEndpointRequestAgnosticDto, any, any>,
        Metadata extends HttpApiEndpointMetadata,
    >(args: {
